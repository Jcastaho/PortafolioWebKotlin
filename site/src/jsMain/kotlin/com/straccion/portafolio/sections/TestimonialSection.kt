...
import com.straccion.portafolio.components.TestimonialCard
import com.straccion.portafolio.models.Section
import com.straccion.portafolio.models.Testimonial
        ...
        Box {
            testimonial1.forEach {testimonial ->
                TestimonialCard(
                    modifier = Modifier
                        .margin(
                            right = if (breakpoint > Breakpoint.SM) 20.px else 0.px,
                        ...
                        .transition(
                            Transition.of("visibility", 300.ms),
